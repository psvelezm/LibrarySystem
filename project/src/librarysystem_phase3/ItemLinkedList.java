 ...
 * @author Matt
 */
public class ItemLinkedList implements Serializable 

{
    ...
    public void add(int index, Item e) {
        if (index < 0 || index > size()) {
            String message = "Index outof bounds";
    ...
    public Item remove(int index) {
        ...
        Item element;  // The element to return     
        if (index == 0) {
    ...
    /**
     * Find an element within the linked list.
     *
     * @param item
     * @return
     */
